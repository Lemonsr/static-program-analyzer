...
namespace spa {
  ...
  public:
    ...
    template <typename T>
    static bool isOptionalVectorEqual(std::optional<std::vector<T>>& expected, std::optional<std::vector<T>>& actual) {
    ...
    static bool isOptionalVectorEqual(std::optional<std::vector<std::pair<int, std::string>>>& expected,
