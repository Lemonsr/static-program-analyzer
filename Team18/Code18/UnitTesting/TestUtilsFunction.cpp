...
public:
  ...
  TEST_METHOD(TestUtilsFunctionIsOptionalVectorEqualWithString) {
    std::optional<std::vector<std::string>> firstStringVec = {{"a", "b", "c"}};
    std::optional<std::vector<std::string>> secondStringVec = {{"a", "b", "c"}};
    std::optional<std::vector<std::string>> thirdStringVec = {{"a", "c"}};

    Assert::IsTrue(spa::UtilsFunction::isOptionalVectorEqual(firstStringVec,
      secondStringVec));
    Assert::IsFalse(spa::UtilsFunction::isOptionalVectorEqual(firstStringVec,
      thirdStringVec));
  }

  TEST_METHOD(TestUtilsFunctionIsOptionalVectorEqualWithInt) {
    std::optional<std::vector<int>> firstIntVec = {{1, 2, 3}};
    std::optional<std::vector<int>> secondIntVec = {{1, 2, 3}};
    std::optional<std::vector<int>> thirdIntVec = {{1, 2}};

    Assert::IsTrue(spa::UtilsFunction::isOptionalVectorEqual(firstIntVec,
      secondIntVec));
    Assert::IsFalse(spa::UtilsFunction::isOptionalVectorEqual(firstIntVec,
      thirdIntVec));
  }

  TEST_METHOD(TestUtilsFunctionIsOptionalVectorEqualWithPairs) {
    std::optional<std::vector<std::pair<int, std::string>>> firstPairVec = {
      {
        {1, "a"},
        {2, "b"}, {3, "c"}
      }
    };
    std::optional<std::vector<std::pair<int, std::string>>> secondPairVec = {
      {
        {1, "a"},
        {2, "b"}, {3, "c"}
      }
    };
    std::optional<std::vector<std::pair<int, std::string>>> thirdPairVec = {
      {
        {1, "a"},
        {2, "b"}
      }
    ...
    Assert::IsTrue(spa::UtilsFunction::isOptionalVectorEqual(firstPairVec,
      secondPairVec));
    Assert::IsFalse(spa::UtilsFunction::isOptionalVectorEqual(firstPairVec,
      thirdPairVec));
  }
};
}  // namespace UnitTesting
